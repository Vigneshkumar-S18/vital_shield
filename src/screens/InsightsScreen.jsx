...
export const InsightsScreen = () => {
  const { goBack, insightsSubTab, setInsightsSubTab, keyInsightsData } = useApp();
  const [expandedId, setExpandedId] = useState('ins-1');
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div style={{ fontSize: '13px', color: '#6A7869', fontWeight: '600' }}>Your Health Score</div>
          
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginTop: '6px' }}>
            <div style={{ display: 'flex', alignItems: 'baseline', gap: '4px' }}>
              <span style={{ fontSize: '36px', fontWeight: '800', color: '#1B2C1E' }}>86</span>
          ...
          <p style={{ fontSize: '12.5px', color: '#6A7869', marginTop: '8px' }}>
              ...
              return (
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
                    ...
                    <div style={{ flex: 1 }}>
                      <div style={{ fontSize: '13.5px', fontWeight: '700', color: '#1B2C1E' }}>{item.title}</div>
                  ...
                  {/* PRD Explainability Dropdown: What changed? What contributed? What remained stable? */}
                  {isExpanded && item.details && (
                    ...
                    >
                      ...
                      <div style={{ backgroundColor: '#F0EDE3', padding: '8px 10px', borderRadius: '8px', marginTop: '4px' }}>
