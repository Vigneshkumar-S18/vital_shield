...
6. **Live Location Tracking**: Activated during an SOS emergency; displays a city street grid map with pulsing concentric radar rings, GPS beacon, coordinates (`13.35682° N, 80.14227° E` / `13° 21′ 25″ N, 80° 8′ 32″ E`), temporary shareable tracking link generation, and contact notification delivery confirmation.
